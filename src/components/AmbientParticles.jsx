...
const particles = [
  // Bord gauche
  { x: "1.8%",  y: "10%",  label: "</>",    size: 11, color: "rgba(56, 189, 248, 0.55)",  duration: 5.5, delay: 0 },
  ...
  { x: "96.5%", y: "34%",  label: "fn()",   size: 10, color: "rgba(251, 146, 60, 0.55)",  duration: 7.8, delay: 2 },
  ...
  // Haut / bas
  { x: "14%",   y: "2%",   label: "const",  size: 10, color: "rgba(52, 211, 153, 0.55)",  duration: 6,   delay: 1.2 },
